 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Models\Post\Entity[] $posts
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Entity whereEmailVerifiedAt($value)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Entity wherePassword($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Entity whereRememberToken($value)
...
class Entity extends Authenticatable
{
    ...
    {
        return $this->hasMany(Post\Entity::class,"user_id");
    }
}
